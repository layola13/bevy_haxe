...
- Color operations: mix, darker, lighter
...
- Add const predefined colors (RED, GREEN, BLUE, etc.)

### Step 5: Enhance LinearRgba.hx
- Add HSV constructor
- Add HWB constructor
- Add const predefined colors
- Add to/from array methods

### Step 6: Enhance Hsla.hx
- Add HSV constructor
- Add HWB constructor
- Add withHue() method
- Add withSaturation() method
- Add withLightness() method
...
- Add predefined color constants

### Step 8: Enhance ColorConversion.hx
- Add HSV conversions
- Add HWB conversions
- Complete conversion matrix for all color spaces
...
### Modified Files
- `src/haxe/color/Color.hx` - Enhanced with new constructors and properties
- `src/haxe/color/Srgba.hx` - Added HSV/HWB constructors, predefined colors
- `src/haxe/color/LinearRgba.hx` - Added HSV/HWB constructors, predefined colors
- `src/haxe/color/Hsla.hx` - Added with*() methods, predefined colors
- `src/haxe/color/ColorConversion.hx` - Complete conversions
- `src/haxe/color/HaxeMath.hx` - Additional math functions

---

## Testing Strategy

1. **Color space round-trip conversions** (e.g., Srgba → Hsla → Srgba)
2. **Alpha channel preservation** in all conversions
3. **Hue wrap-around behavior** (0° ≡ 360°)
4. **Test all static constructors** (srgb, hsv, hsl, hwb, linear)
...
To rollback:
1. Restore previous versions of modified files from version control
2. Delete newly created files (Hsva.hx, Hwba.hx)
